    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          @include('block.message')
                ...
                {!! csrf_field() !!}
            <div class="more">
              <a href="/admin/catepost/add.html" class="btn btn-success">Thêm mới</a>
                  ...
                  <table id="datatable-keytable" class="table table-striped jambo_table table-bordered bulk_action">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{!! \App\Helpers\Helpers::get_type_catepost($cate->is_menu) !!}</td>
                        <td  style="text-align:right">
                            {{--<a href="/admin/cate/view/{{ $cate->slug }}.html" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Xem</a>--}}
                            <a href="/admin/catepost/edit/{{ $cate->slug }}.html" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Sửa</a>
                            <a href="/admin/catepost/delete/{{ $cate->slug }}.html" class="btn btn-warning btn-xs" onclick="xacnhanxoa('Bạn có muốn xóa không ?')"><i class="fa fa-trash"></i> Xóa</a>
                        </td>
                      </tr>
                       @endforeach
                    </tbody>
