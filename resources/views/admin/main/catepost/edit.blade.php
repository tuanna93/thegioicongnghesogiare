                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3 col-sm-9 col-xs-12">
                                    <select class="form-control" name="kieutrang" id="kieutrang">
                                        ...
                                        <option value="1" <?php if($cate->is_menu==1) echo "selected" ?>>Nhóm tin tức</option>
                                        <option value="2" <?php if($cate->is_menu==2) echo "selected" ?>>Nhóm tin tức menu dưới</option>
                                    </select>
                                </div>
                            </div>
                                <div class="form-group">
