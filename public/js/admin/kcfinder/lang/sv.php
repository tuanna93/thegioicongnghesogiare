...
$lang = array(
    ...
    "Please enter post folder name." => "Vänligen skriv in ny mapp-namn",
    ...
    "Please enter post file name." => "Ange nytt filnamn.",
    ...
    "Clipboard" => "Urklipp",
    "Checking for post version..." => "Söka efter ny version ...",
