...
$lang = array(
    ...
    "Please enter post folder name." => "Por favor, digite o nome da nova pasta.",
    ...
    "Please enter post file name." => "Por favor, digite o novo nome de arquivo.",
    ...
    "Checking for post version..." => "Checando por nova versão...",
