...
$lang = array(
    ...
    "Please enter post folder name." => "Kirjoita uuden kansion nimi.",
    ...
    "Please enter post file name." => "Kirjoita uusi tiedostonimi.",
    ...
    "Checking for post version..." => "Tarkastetaan uusin versio...",
