...
$lang = array(
    ...
    "Please enter post folder name." => "Παρακαλούμε εισάγετε ένα νέο όνομα φακέλου. ",
    ...
    "Please enter post file name." => "Παρακαλούμε εισάγετε ένα νέο όνομα αρχείου.",
    ...
    "Clipboard" => "Πρόχειρο",
    "Checking for post version..." => "Ελεγχος για νέα έκδοση...",
