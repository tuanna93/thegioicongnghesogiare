...
$lang = array(
    ...
    "Please enter post folder name." => "Укажите имя новой папки.",
    ...
    "Please enter post file name." => "Укажите новое имя файла",
    ...
    "Checking for post version..." => "Проверяем наличие обновлений...",
