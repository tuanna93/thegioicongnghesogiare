...
$lang = array(
    ...
    "Please enter post folder name." => "Vložte prosím nové jméno adresáře.",
    ...
    "Please enter post file name." => "Vložte prosím nové jméno souboru.",
    ...
    "Clipboard" => "Schránka",
    "Checking for post version..." => "Zkontrolovat novou verzi...",
