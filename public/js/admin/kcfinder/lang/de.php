...
$lang = array(
    ...
    "Please enter post folder name." => "Bitte einen neuen Ordnernamen angeben.",
    ...
    "Please enter post file name." => "Bitte gib einen neuen Dateinamen an.",
    ...
    "Checking for post version..." => "Nach neuer Version suchen",
