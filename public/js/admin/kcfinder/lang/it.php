...
$lang = array(
    ...
    "Please enter post folder name." => "Scrivi il nome della nuova cartella.",
    ...
    "Please enter post file name." => "Inserisci il nuovo nome del file",
    ...
    "Clipboard" => "Clipboard",
    "Checking for post version..." => "Controllo nuova versione...",
