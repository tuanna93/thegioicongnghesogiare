...
$lang = array(
    ...
    "Please enter post folder name." => "Por favor introduzca el nombre de la nueva carpeta.",
    ...
    "Please enter post file name." => "Por favor introduzca el nuevo nombre del archivo.",
    ...
    "Checking for post version..." => "Verificando nuevas versiones...",
