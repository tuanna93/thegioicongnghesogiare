...
$lang = array(
    ...
    "Please enter post folder name." => "Lūdzu, ievadiet jaunu mapes nosaukumu.",
    ...
    "Please enter post file name." => "Lūdzu, ievadiet jaunu faila nosaukumu.",
    ...
    "Checking for post version..." => "... jaunās versijas pārbaude",
