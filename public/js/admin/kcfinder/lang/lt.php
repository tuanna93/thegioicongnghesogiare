...
$lang = array(
    ...
    "Please enter post folder name." => "Įveskite katalogo pavadinimą.",
    ...
    "Please enter post file name." => "Įveskite failo pavadinimą.",
    ...
    "Checking for post version..." => "Tikrinama nauja versija...",
