...
$lang = array(
    ...
    "Please enter post folder name." => "Merci d'entrer le nouveau nom de dossier.",
    ...
    "Please enter post file name." => "Merci d'entrer le nouveau nom de fichier",
    ...
    "Checking for post version..." => "Vérifier les mises à jours...",
