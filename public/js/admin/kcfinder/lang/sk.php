...
$lang = array(
    ...
    "Please enter post folder name." => "Zadajte prosím nové meno adresára.",
    ...
    "Please enter post file name." => "Vložte prosím nové meno súboru.",
    ...
    "Clipboard" => "Schránka",
    "Checking for post version..." => "Kontrolujem novú verziu...",
