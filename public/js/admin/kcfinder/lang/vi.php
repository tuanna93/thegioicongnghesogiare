...
$lang = array(
    ...
    "Please enter post folder name." => "Vui lòng nhập tên thư mục",
    ...
    "Please enter post file name." => "Vui lòng nhập tên tập tin",
    ...
    "Clipboard" => "Bộ nhớ",
    "Checking for post version..." => "Kiểm tra phiên bản mới",
