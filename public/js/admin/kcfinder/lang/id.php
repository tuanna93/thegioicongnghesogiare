...
$lang = array(
    ...
    "Please enter post folder name." => "Tolong masukkan nama folder baru.",
    ...
    "Please enter post file name." => "Tolong masukkan nama file baru.",
    ...
    "Clipboard" => "Clipboard",
    "Checking for post version..." => "Mengecek untuk versi baru...",
