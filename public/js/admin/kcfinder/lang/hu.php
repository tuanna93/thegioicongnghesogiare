...
$lang = array(
    ...
    "Please enter post folder name." => "Kérem, adja meg az új könyvtár nevét.",
    ...
    "Please enter post file name." => "Kérem adja meg az új fájl nevét.",
    ...
    "Clipboard" => "Vágólap",
    "Checking for post version..." => "Új verzió keresése ...",
