...
$lang = array(
    ...
    "Please enter post folder name." => "Вкажіть назву нової папки.",
    ...
    "Please enter post file name." => "Вкажіть нову назву файла",
    ...
    "Checking for post version..." => "Перевіряємо наявність оновлень...",
